...
class Vrfy(models.Model):
    ...
    VRFY_TYPE_CD = models.CharField(verbose_name="검증유형코드",max_length=2 ,choices=VRFY_TYPE_CD_LIST, default='LC')
    VRFY_CNTS = models.TextField(verbose_name="검증내용",max_length=4000,default=None, blank=True, null=True)

    #BKUP_YN = models.BooleanField(verbose_name="백업여부",default=False)
    #USE_YN = models.BooleanField(verbose_name="사용여부",default=True)
    BKUP_YN = models.CharField(verbose_name="백업여부",max_length=1,choices=YN_LIST, default='N')
