...
class TableNameForm(forms.Form):
    """
    테이블명을 입력받는다.
    """

    tblNm = forms.CharField()
...
class AttrNameForm(forms.Form):
    """
    속성명을 입력받는다.
    """

    attrNm = forms.CharField()
...
class ColNameForm(forms.Form):
    """
    컬럼명을 입력받는다.
    """

    colNm = forms.CharField()
